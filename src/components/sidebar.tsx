      ...
      <Layout>
        ...
        <LayoutHeader className='sticky top-0 justify-between px-4 py-3 border-b-2 border-b-muted md:px-4'>
          <div className={`flex items-center ${!isCollapsed ? 'gap-2' : ''}`}>
            <svg xmlns="http://www.w3.org/2000/svg" className={`icon icon-tabler icon-tabler-alien-filled text-primary ${isCollapsed ? 'h-6 w-6' : 'h-8 w-8'}`} width="44" height="44" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#2c3e50" fill="none" strokeLinecap="round" strokeLinejoin="round">
